...
public class EnemySpawningEditor : Editor
{
    ...
    void DisplayBasicInfo()
    {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("DelayBetweenSpawnsMin"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("DelayBetweenSpawnsMax"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("StrongEnemySpawnWait"));
    }
